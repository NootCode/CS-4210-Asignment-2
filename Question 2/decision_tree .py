...
dataSets = ['Question 2\contact_lens_training_1.csv', 'Question 2\contact_lens_training_2.csv', 'Question 2\contact_lens_training_3.csv']
...
for ds in dataSets:
    ...
    for i in range (10):
        ...
        #--> add your Python code here
        dbTest = []
        with open('Question 2\contact_lens_test.csv', 'r') as csvfile:
            reader = csv.reader(csvfile)
            for i, row in enumerate(reader):
                if i > 0:  # skipping the header
                    dbTest.append(row)
